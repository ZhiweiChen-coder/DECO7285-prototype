    ...
    !function(e) {
      ...
      return (/* @__PURE__ */ function() {
          ...
          (function() {
            ...
            function _(e2, t2) {
              ...
              if (0 === n2.length) {
                ...
                if (void 0 === (n2 = e2.topicAliasSend.getTopicByAlias(r3))) return new Error("Unregistered Topic Alias");
                t2.topic = n2;
              }
            ...
            function S(e2, t2, r3, n2) {
              ...
              let i2, o2 = t2;
              if ("publish" === o2.cmd && (o2 = p(t2), i2 = _(e2, o2))) return r3 && r3(i2);
            ...
            function C(e2, t2) {
              let r3;
              const n2 = this;
              if (!(this instanceof C)) return new C(e2, t2);
              for (r3 in this.options = t2 || {}, v) void 0 === this.options[r3] ? this.options[r3] = v[r3] : this.options[r3] = t2[r3];
              y("MqttClient :: options.protocol", t2.protocol), y("MqttClient :: options.protocolVersion", t2.protocolVersion), y("MqttClient :: options.username", t2.username), y("MqttClient :: options.keepalive", t2.keepalive), y("MqttClient :: options.reconnectPeriod", t2.reconnectPeriod), y("MqttClient :: options.rejectUnauthorized", t2.rejectUnauthorized), y("MqttClient :: options.topicAliasMaximum", t2.topicAliasMaximum), this.options.clientId = "string" == typeof t2.clientId ? t2.clientId : "mqttjs_" + Math.random().toString(16).substr(2, 8), y("MqttClient :: clientId", this.options.clientId), this.options.customHandleAcks = 5 === t2.protocolVersion && t2.customHandleAcks ? t2.customHandleAcks : function() {
                ...
                y("connect :: sending queued packets"), function t3() {
                  ...
                  let i2 = null;
                  if (!r4) return void n2._resubscribe();
            ...
            h(C, i), C.prototype._setupStream = function() {
              ...
              function s2() {
                ...
                const t3 = i2.shift();
                if (t3) y("work :: packet pulled from queue"), e2._handlePacket(t3, o2);
                else {
              ...
              if (a2.cmd = "connect", this.topicAliasRecv && (a2.properties || (a2.properties = {}), this.topicAliasRecv && (a2.properties.topicAliasMaximum = this.topicAliasRecv.max)), k(this, a2), r3.on("error", this.emit.bind(this, "error")), this.options.properties) {
                if (!this.options.properties.authenticationMethod && this.options.properties.authenticationData) return e2.end(() => this.emit("error", new Error("Packet has no Authentication Method"))), this;
              ...
              if (5 === r3.protocolVersion && r3.properties && r3.properties.maximumPacketSize && r3.properties.maximumPacketSize < e2.length) return this.emit("error", new Error("exceeding packets size " + e2.cmd)), this.end({ reasonCode: 149, properties: { reasonString: "Maximum packet size was exceeded" } }), this;
              ...
              if (r3 = g({ qos: 0, retain: false, dup: false }, r3), this._checkDisconnecting(n2)) return this;
              const o2 = this, s2 = function() {
                let s3 = 0;
                if ((1 === r3.qos || 2 === r3.qos) && null === (s3 = o2._nextId())) return y("No messageId left"), false;
              ...
              for (let e3 = 0; e3 < arguments.length; e3++) t2[e3] = arguments[e3];
              const r3 = [];
              let n2 = t2.shift();
              ...
              if (null !== l2) return m(o2, new Error("Invalid topic " + l2)), this;
              if (this._checkDisconnecting(o2)) return y("subscribe: discconecting true"), this;
              const u2 = { qos: 0 };
              ...
              const c2 = function() {
                const t3 = e2._nextId();
                if (null === t3) return y("No messageId left"), false;
                ...
                return e2.outgoing[n3.messageId] = { volatile: true, cb: function(e3, t4) {
                  if (!e3) {
                    const e4 = t4.granted;
                    for (let t5 = 0; t5 < e4.length; t5 += 1) r3[t5].qos = e4[t5];
                  }
                  o2(e3, r3);
              ...
              if (null !== o2) return m(n2, new Error("Invalid topic " + o2)), this;
              if (e2._checkDisconnecting(n2)) return this;
              const s2 = function() {
                const t3 = e2._nextId();
                if (null === t3) return y("No messageId left"), false;
              ...
              if (t2 && (y("_cleanUp :: done callback provided for on stream close"), this.stream.on("close", t2)), y("_cleanUp :: forced? %s", e2), e2) 0 === this.options.reconnectPeriod && this.options.clean && (n2 = this.outgoing) && (y("flush: queue exists? %b", !!n2), Object.keys(n2).forEach(function(e3) {
              ...
              if (n2) t2(n2);
                ...
                if (!this.connected) return "auth" === e2.cmd ? (this._shiftPingInterval(), void k(this, e2, t2)) : (y("_sendPacket :: client not connected. Storing packet offline."), void this._storePacket(e2, t2, r3));
              ...
              if (clearTimeout(this.connackTimer), delete this.topicAliasSend, e2.properties) {
                if (e2.properties.topicAliasMaximum) {
                  if (e2.properties.topicAliasMaximum > 65535) return void this.emit("error", new Error("topicAliasMaximum from broker is out of range"));
              ...
              if (0 === r3) this.reconnecting = false, this._onConnect(e2);
              else if (r3 > 0) {
              ...
              this.handleAuth(e2, function(e3, t3) {
                if (e3) n2.emit("error", e3);
                else if (24 === r3) n2.reconnecting = false, n2._sendPacket(t3);
                else {
              ...
              if (5 === this.options.protocolVersion) {
                let t3;
                if (e2.properties && (t3 = e2.properties.topicAlias), void 0 !== t3) if (0 === r3.length) {
                  if (!(t3 > 0 && t3 <= 65535)) return y("_handlePublish :: topic alias out of range. alias: %d", t3), void this.emit("error", new Error("Received Topic Alias is out of range"));
                  {
                    const e3 = this.topicAliasRecv.getTopicByAlias(t3);
                    if (!e3) return y("_handlePublish :: unregistered topic alias. alias: %d", t3), void this.emit("error", new Error("Received unregistered Topic Alias"));
                    y("_handlePublish :: topic complemented by alias. topic: %s - alias: %d", r3 = e3, t3);
                  }
                } else {
                  if (!this.topicAliasRecv.put(r3, t3)) return y("_handlePublish :: topic alias out of range. alias: %d", t3), void this.emit("error", new Error("Received Topic Alias is out of range"));
              ...
              if (i2) {
                switch (y("_handleAck :: packet type", r3), r3) {
                  ...
                  case "suback":
                    ...
                    for (let r4 = 0; r4 < e2.granted.length; r4++) if (0 != (128 & e2.granted[r4])) {
              ...
              if (!this._firstConnection && (this.options.clean || 5 === this.options.protocolVersion && !this.connackPacket.sessionPresent) && e2.length > 0) if (this.options.resubscribe) if (5 === this.options.protocolVersion) {
              ...
              if (this.disconnected) return void this.emit("connect", e2);
              const t2 = this;
              this.connackPacket = e2, this.messageIdProvider.clear(), this._setupPingTimer(), this.connected = true, function r3() {
                ...
                t2.once("close", o2), n2.on("error", function(e3) {
                  ...
                  let n3 = true;
                  for (const e3 in t2._packetIdsDuringStoreProcessing) if (!t2._packetIdsDuringStoreProcessing[e3]) {
                    n3 = false;
                    break;
                  }
              ...
              if (this._storeProcessingQueue.length > 0) {
                ...
                if (e2 && e2.invoke()) return this._storeProcessingQueue.shift(), true;
              }
              return false;
            }, C.prototype._invokeAllStoreProcessingQueue = function() {
              for (; this._invokeStoreProcessingQueue(); ) ;
            }, C.prototype._flushStoreProcessingQueue = function() {
              for (const e2 of this._storeProcessingQueue) e2.cbStorePut && e2.cbStorePut(new Error("Connection closed")), e2.callback && e2.callback(new Error("Connection closed"));
        ...
        t.exports = function(e2, t2) {
          if (t2.hostname = t2.hostname || t2.host, !t2.hostname) throw new Error("Could not determine host. Specify host manually.");
          ...
          (function() {
            ...
            t.exports = u ? function(e2, t2) {
              ...
              function v(e3, t3) {
                ...
                for (let t4 = 0; t4 < e3.length; t4++) "string" == typeof e3[t4].chunk ? r4[t4] = n.from(e3[t4], "utf8") : r4[t4] = e3[t4].chunk;
        ...
        o.prototype.put = function(e2, t2) {
          if (0 === t2 || t2 > this.max) return false;
        ...
        function n(e2) {
          const t2 = e2.split("/");
          for (let e3 = 0; e3 < t2.length; e3++) if ("+" !== t2[e3]) {
            if ("#" === t2[e3]) return e3 === t2.length - 1;
            if (-1 !== t2[e3].indexOf("+") || -1 !== t2[e3].indexOf("#")) return false;
          }
          return true;
        }
        t.exports = { validateTopics: function(e2) {
          if (0 === e2.length) return "empty_topic_list";
          for (let t2 = 0; t2 < e2.length; t2++) if (!n(e2[t2])) return e2[t2];
          return null;
        } };
      }, {}], 12: [function(e, t, r) {
        (function(r2) {
          (function() {
            ...
            function u(e2, t2) {
              if (a("connecting to an MQTT broker..."), "object" != typeof e2 || t2 || (t2 = e2, e2 = null), t2 = t2 || {}, e2) {
                ...
                if (null != r4.port && (r4.port = Number(r4.port)), null === (t2 = s(r4, t2)).protocol) throw new Error("Missing protocol");
              ...
              if (function(e3) {
                ...
                if (!t2.protocol) throw new Error("Missing secure protocol key");
                if (-1 === ["mqtts", "wss", "wxs", "alis"].indexOf(t2.protocol)) switch (t2.protocol) {
                  case "mqtt":
                    t2.protocol = "mqtts";
                    break;
                  case "ws":
              ...
              if (false === t2.clean && !t2.clientId) throw new Error("Missing clientId for unclean clients");
        ...
        r.byteLength = function(e2) {
          ...
          for (r2 = 0; r2 < h; r2 += 4) t2 = i[e2.charCodeAt(r2)] << 18 | i[e2.charCodeAt(r2 + 1)] << 12 | i[e2.charCodeAt(r2 + 2)] << 6 | i[e2.charCodeAt(r2 + 3)], l2[c2++] = t2 >> 16 & 255, l2[c2++] = t2 >> 8 & 255, l2[c2++] = 255 & t2;
          ...
          for (var t2, r2 = e2.length, i2 = r2 % 3, o2 = [], s2 = 0, a2 = r2 - i2; s2 < a2; s2 += 16383) o2.push(c(e2, s2, s2 + 16383 > a2 ? a2 : s2 + 16383));
        ...
        function c(e2, t2, r2) {
          for (var i2, o2, s2 = [], a2 = t2; a2 < r2; a2 += 3) i2 = (e2[a2] << 16 & 16711680) + (e2[a2 + 1] << 8 & 65280) + (255 & e2[a2 + 2]), s2.push(n[(o2 = i2) >> 18 & 63] + n[o2 >> 12 & 63] + n[o2 >> 6 & 63] + n[63 & o2]);
          return s2.join("");
        }
        ...
        o._init = function(e2) {
          ...
          for (let r2 = 0; r2 < this._bufs.length; r2++) {
            ...
            if (e2 < n2 || r2 === this._bufs.length - 1) return [r2, e2 - t2];
            t2 = n2;
          }
        }, o.prototype._reverseOffset = function(e2) {
          const t2 = e2[0];
          let r2 = e2[1];
          for (let e3 = 0; e3 < t2; e3++) r2 += this._bufs[e3].length;
          return r2;
        }, o.prototype.get = function(e2) {
          if (e2 > this.length || e2 < 0) return;
          ...
          if (("number" != typeof r2 || r2 < 0) && (r2 = 0), ("number" != typeof i2 || i2 > this.length) && (i2 = this.length), r2 >= this.length) return e2 || n.alloc(0);
          if (i2 <= 0) return e2 || n.alloc(0);
          const o2 = !!e2, s = this._offset(r2), a = i2 - r2;
          let l = a, u = o2 && t2 || 0, c = s[1];
          if (0 === r2 && i2 === this.length) {
            if (!o2) return 1 === this._bufs.length ? this._bufs[0] : n.concat(this._bufs, this.length);
            for (let t3 = 0; t3 < this._bufs.length; t3++) this._bufs[t3].copy(e2, u), u += this._bufs[t3].length;
            return e2;
          }
          if (l <= this._bufs[s[0]].length - c) return o2 ? this._bufs[s[0]].copy(e2, t2, c, c + l) : this._bufs[s[0]].slice(c, c + l);
          ...
          if (e2 = e2 || 0, t2 = "number" != typeof t2 ? this.length : t2, e2 < 0 && (e2 += this.length), t2 < 0 && (t2 += this.length), e2 === t2) return this._new();
          ...
          if (e2 = Math.trunc(e2), Number.isNaN(e2) || e2 <= 0) return this;
          ...
          const e2 = this._new();
          for (let t2 = 0; t2 < this._bufs.length; t2++) e2.append(this._bufs[t2]);
          return e2;
        }, o.prototype.append = function(e2) {
          if (null == e2) return this;
          if (e2.buffer) this._appendBuffer(n.from(e2.buffer, e2.byteOffset, e2.byteLength));
          else if (Array.isArray(e2)) for (let t2 = 0; t2 < e2.length; t2++) this.append(e2[t2]);
          else if (this._isBufferList(e2)) for (let t2 = 0; t2 < e2._bufs.length; t2++) this.append(e2._bufs[t2]);
          else "number" == typeof e2 && (e2 = e2.toString()), this._appendBuffer(n.from(e2));
          return this;
        }, o.prototype._appendBuffer = function(e2) {
          this._bufs.push(e2), this.length += e2.length;
        }, o.prototype.indexOf = function(e2, t2, r2) {
          if (void 0 === r2 && "string" == typeof t2 && (r2 = t2, t2 = void 0), "function" == typeof e2 || Array.isArray(e2)) throw new TypeError('The "value" argument must be one of type string, Buffer, BufferList, or Uint8Array.');
          if ("number" == typeof e2 ? e2 = n.from([e2]) : "string" == typeof e2 ? e2 = n.from(e2, r2) : this._isBufferList(e2) ? e2 = e2.slice() : Array.isArray(e2.buffer) ? e2 = n.from(e2.buffer, e2.byteOffset, e2.byteLength) : n.isBuffer(e2) || (e2 = n.from(e2)), t2 = Number(t2 || 0), isNaN(t2) && (t2 = 0), t2 < 0 && (t2 = this.length + t2), t2 < 0 && (t2 = 0), 0 === e2.length) return t2 > this.length ? this.length : t2;
          ...
          for (; o2 < this._bufs.length; o2++) {
            ...
            for (; s < t3.length; ) {
              if (t3.length - s >= e2.length) {
                ...
                if (-1 !== r3) return this._reverseOffset([o2, r3]);
                s = t3.length - e2.length + 1;
              } else {
                const t4 = this._reverseOffset([o2, s]);
                if (this._match(t4, e2)) return t4;
                s++;
              }
            }
            s = 0;
          ...
          if (this.length - e2 < t2.length) return false;
          for (let r2 = 0; r2 < t2.length; r2++) if (this.get(e2 + r2) !== t2[r2]) return false;
          return true;
        }, function() {
          ...
          for (const t2 in e2) !function(t3) {
        ...
        (function(t2) {
          (function() {
            ...
            var i = 2147483647;
            function o(e2) {
              if (e2 > i) throw new RangeError('The value "' + e2 + '" is invalid for option "size"');
            ...
            function a(e2, t4, r2) {
              ...
              if (q(e2, ArrayBuffer) || e2 && q(e2.buffer, ArrayBuffer)) return function(e3, t5, r3) {
              ...
              var i2 = function(e3) {
                ...
                if (void 0 !== e3.length) return "number" != typeof e3.length || D(e3.length) ? o(0) : c(e3);
            ...
            function c(e2) {
              for (var t4 = e2.length < 0 ? 0 : 0 | h(e2.length), r2 = o(t4), n2 = 0; n2 < t4; n2 += 1) r2[n2] = 255 & e2[n2];
              return r2;
            }
            function h(e2) {
              if (e2 >= i) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + i.toString(16) + " bytes");
              return 0 | e2;
            }
            function f(e2, t4) {
              if (s.isBuffer(e2)) return e2.length;
              if (ArrayBuffer.isView(e2) || q(e2, ArrayBuffer)) return e2.byteLength;
            ...
            function d(e2, t4, r2, n2, i2) {
              ...
              if ("string" == typeof t4 && (t4 = s.from(t4, n2)), s.isBuffer(t4)) return 0 === t4.length ? -1 : g(e2, t4, r2, n2, i2);
              if ("number" == typeof t4) return t4 &= 255, "function" == typeof Uint8Array.prototype.indexOf ? i2 ? Uint8Array.prototype.indexOf.call(e2, t4, r2) : Uint8Array.prototype.lastIndexOf.call(e2, t4, r2) : g(e2, [t4], r2, n2, i2);
            ...
            function g(e2, t4, r2, n2, i2) {
              ...
              if (i2) {
                var c2 = -1;
                for (o2 = r2; o2 < a2; o2++) if (u2(e2, o2) === u2(t4, -1 === c2 ? 0 : o2 - c2)) {
                  if (-1 === c2 && (c2 = o2), o2 - c2 + 1 === l2) return c2 * s2;
                } else -1 !== c2 && (o2 -= o2 - c2), c2 = -1;
              } else for (r2 + l2 > a2 && (r2 = a2 - l2), o2 = r2; o2 >= 0; o2--) {
                for (var h2 = true, f2 = 0; f2 < l2; f2++) if (u2(e2, o2 + f2) !== u2(t4, f2)) {
                  h2 = false;
                  break;
                }
                if (h2) return o2;
            ...
            function _(e2, t4, r2, n2) {
              return U(function(e3, t5) {
                for (var r3, n3, i2, o2 = [], s2 = 0; s2 < e3.length && !((t5 -= 2) < 0); ++s2) r3 = e3.charCodeAt(s2), n3 = r3 >> 8, i2 = r3 % 256, o2.push(i2), o2.push(n3);
                return o2;
            ...
            function S(e2, t4, r2) {
              ...
              return function(e3) {
                var t5 = e3.length;
                if (t5 <= E) return String.fromCharCode.apply(String, e3);
                var r3 = "", n3 = 0;
                for (; n3 < t5; ) r3 += String.fromCharCode.apply(String, e3.slice(n3, n3 += E));
                return r3;
              }(n2);
            }
            r.kMaxLength = i, s.TYPED_ARRAY_SUPPORT = function() {
              ...
              if (q(e2, Uint8Array) && (e2 = s.from(e2, e2.offset, e2.byteLength)), q(t4, Uint8Array) && (t4 = s.from(t4, t4.offset, t4.byteLength)), !s.isBuffer(e2) || !s.isBuffer(t4)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
              if (e2 === t4) return 0;
              ...
              for (r2 = 0; r2 < e2.length; ++r2) {
                var o2 = e2[r2];
                if (q(o2, Uint8Array) && (o2 = s.from(o2)), !s.isBuffer(o2)) throw new TypeError('"list" argument must be an Array of Buffers');
              ...
              for (var t4 = 0; t4 < e2; t4 += 2) p(this, t4, t4 + 1);
              return this;
            }, s.prototype.swap32 = function() {
              var e2 = this.length;
              if (e2 % 4 != 0) throw new RangeError("Buffer size must be a multiple of 32-bits");
              for (var t4 = 0; t4 < e2; t4 += 4) p(this, t4, t4 + 3), p(this, t4 + 1, t4 + 2);
              return this;
            }, s.prototype.swap64 = function() {
              var e2 = this.length;
              if (e2 % 8 != 0) throw new RangeError("Buffer size must be a multiple of 64-bits");
              for (var t4 = 0; t4 < e2; t4 += 8) p(this, t4, t4 + 7), p(this, t4 + 1, t4 + 6), p(this, t4 + 2, t4 + 5), p(this, t4 + 3, t4 + 4);
              return this;
              ...
              if (q(e2, Uint8Array) && (e2 = s.from(e2, e2.offset, e2.byteLength)), !s.isBuffer(e2)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof e2);
              ...
              if (n2 >= i2) return -1;
              if (t4 >= r2) return 1;
              if (t4 >>>= 0, r2 >>>= 0, n2 >>>= 0, i2 >>>= 0, this === e2) return 0;
              for (var o2 = i2 - n2, a2 = r2 - t4, l2 = Math.min(o2, a2), u2 = this.slice(n2, i2), c2 = e2.slice(t4, r2), h2 = 0; h2 < l2; ++h2) if (u2[h2] !== c2[h2]) {
                o2 = u2[h2], a2 = c2[h2];
                break;
              }
            ...
            function x(e2, t4, r2) {
              ...
              for (var i2 = "", o2 = t4; o2 < r2; ++o2) i2 += N(e2[o2]);
              return i2;
            }
            function A(e2, t4, r2) {
              for (var n2 = e2.slice(t4, r2), i2 = "", o2 = 0; o2 < n2.length; o2 += 2) i2 += String.fromCharCode(n2[o2] + 256 * n2[o2 + 1]);
              return i2;
            }
            function I(e2, t4, r2) {
            ...
            s.prototype.slice = function(e2, t4) {
              ...
              for (var n2 = this[e2], i2 = 1, o2 = 0; ++o2 < t4 && (i2 *= 256); ) n2 += this[e2 + o2] * i2;
              return n2;
              ...
              e2 >>>= 0, t4 >>>= 0, r2 || I(e2, t4, this.length);
              for (var n2 = t4, i2 = 1, o2 = this[e2 + --n2]; n2 > 0 && (i2 *= 256); ) o2 += this[e2 + --n2] * i2;
              ...
              var i2 = 1, o2 = 0;
              for (this[t4] = 255 & e2; ++o2 < r2 && (i2 *= 256); ) this[t4 + o2] = e2 / i2 & 255;
              return t4 + r2;
            }, s.prototype.writeUIntBE = function(e2, t4, r2, n2) {
              (e2 = +e2, t4 >>>= 0, r2 >>>= 0, n2) || P(this, e2, t4, r2, Math.pow(2, 8 * r2) - 1, 0);
              var i2 = r2 - 1, o2 = 1;
              for (this[t4 + i2] = 255 & e2; --i2 >= 0 && (o2 *= 256); ) this[t4 + i2] = e2 / o2 & 255;
              return t4 + r2;
              ...
              var o2 = 0, s2 = 1, a2 = 0;
              for (this[t4] = 255 & e2; ++o2 < r2 && (s2 *= 256); ) e2 < 0 && 0 === a2 && 0 !== this[t4 + o2 - 1] && (a2 = 1), this[t4 + o2] = (e2 / s2 >> 0) - a2 & 255;
              return t4 + r2;
              ...
              for (this[t4 + o2] = 255 & e2; --o2 >= 0 && (s2 *= 256); ) e2 < 0 && 0 === a2 && 0 !== this[t4 + o2 + 1] && (a2 = 1), this[t4 + o2] = (e2 / s2 >> 0) - a2 & 255;
              return t4 + r2;
            ...
            function j(e2) {
              return t3.toByteArray(function(e3) {
                if ((e3 = (e3 = e3.split("=")[0]).trim().replace(M, "")).length < 2) return "";
        ...
        (function(n) {
          (function() {
            r.formatArgs = function(e2) {
              if (e2[0] = (this.useColors ? "%c" : "") + this.namespace + (this.useColors ? " %c" : " ") + e2[0] + (this.useColors ? "%c " : " ") + "+" + t.exports.humanize(this.diff), !this.useColors) return;
        ...
        t.exports = function(t2) {
          ...
          return r2.debug = r2, r2.default = r2, r2.coerce = function(e2) {
            ...
            for (t3 = 0; t3 < i2; t3++) n2[t3] && ("-" === (e2 = n2[t3].replace(/\*/g, ".*?"))[0] ? r2.skips.push(new RegExp("^" + e2.substr(1) + "$")) : r2.names.push(new RegExp("^" + e2 + "$")));
          }, r2.enabled = function(e2) {
            if ("*" === e2[e2.length - 1]) return true;
            let t3, n2;
            for (t3 = 0, n2 = r2.skips.length; t3 < n2; t3++) if (r2.skips[t3].test(e2)) return false;
            for (t3 = 0, n2 = r2.names.length; t3 < n2; t3++) if (r2.names[t3].test(e2)) return true;
            return false;
            ...
            let t3 = 0;
            for (let r3 = 0; r3 < e2.length; r3++) t3 = (t3 << 5) - t3 + e2.charCodeAt(r3), t3 |= 0;
        ...
        (function(r2, n) {
          (function() {
            var i = e("readable-stream"), o = e("end-of-stream"), s = e("inherits"), a = e("stream-shift"), l = n.from && n.from !== Uint8Array.from ? n.from([0]) : new n([0]), u = function(e2, t2) {
              ...
              if (!(this instanceof f)) return new f(e2, t2, r3);
            ...
            s(f, i.Duplex), f.obj = function(e2, t2, r3) {
              ...
              if (this._unwrite && this._unwrite(), this.destroyed) e2 && e2.destroy && e2.destroy();
              ...
              if (this._unread && this._unread(), this.destroyed) e2 && e2.destroy && e2.destroy();
              else {
                if (null === e2 || false === e2) return this.push(null), void this.resume();
              ...
              if (!this._forwarding && this._readable2 && this._drained) {
                var e2;
                for (this._forwarding = true; this._drained && null !== (e2 = a(this._readable2)); ) this.destroyed || (this._drained = this.push(e2));
                this._forwarding = false;
              }
            }, f.prototype.destroy = function(e2, t2) {
              if (t2 || (t2 = h), this.destroyed) return t2(null);
              this.destroyed = true;
              var n2 = this;
              ...
              if (!this.destroyed) return this._corked ? u(this, this._write.bind(this, e2, t2, r3)) : e2 === l ? this._finish(r3) : this._writable ? void (false === this._writable.write(e2) ? this._ondrain = r3 : this.destroyed || r3()) : r3();
        ...
        (function(r2) {
          (function() {
            var n = e("once"), i = function() {
              ...
              if ("function" == typeof t2) return o(e2, null, t2);
              t2 || (t2 = {}), s = n(s || i);
              var a = e2._writableState, l = e2._readableState, u = t2.readable || false !== t2.readable && e2.readable, c = t2.writable || false !== t2.writable && e2.writable, h = false, f = function() {
                ...
                if (!h) return (!u || l && l.ended && !l.destroyed) && (!c || a && a.ended && !a.destroyed) ? void 0 : s.call(e2, new Error("premature close"));
              }, v = function() {
                e2.req.on("finish", p);
              };
              return !function(e3) {
        ...
        function h(e2, t2, r2, i2) {
          ...
          } else a2 = s2[t2] = r2, ++e2._eventsCount;
          return e2;
        }
        function f() {
        ...
        a ? Object.defineProperty(s, "defaultMaxListeners", { enumerable: true, get: function() {
          ...
          if (!(r2 = s2[e2])) return false;
          var u2 = "function" == typeof r2;
          switch (n2 = arguments.length) {
            case 1:
              !function(e3, t3, r3) {
                if (t3) e3.call(r3);
                else for (var n3 = e3.length, i3 = y(e3, n3), o3 = 0; o3 < n3; ++o3) i3[o3].call(r3);
              }(r2, u2, this);
              break;
            case 2:
              !function(e3, t3, r3, n3) {
                if (t3) e3.call(r3, n3);
                else for (var i3 = e3.length, o3 = y(e3, i3), s3 = 0; s3 < i3; ++s3) o3[s3].call(r3, n3);
              }(r2, u2, this, arguments[1]);
              break;
            case 3:
              !function(e3, t3, r3, n3, i3) {
                if (t3) e3.call(r3, n3, i3);
                else for (var o3 = e3.length, s3 = y(e3, o3), a3 = 0; a3 < o3; ++a3) s3[a3].call(r3, n3, i3);
              }(r2, u2, this, arguments[1], arguments[2]);
              break;
            case 4:
              !function(e3, t3, r3, n3, i3, o3) {
                if (t3) e3.call(r3, n3, i3, o3);
                else for (var s3 = e3.length, a3 = y(e3, s3), l3 = 0; l3 < s3; ++l3) a3[l3].call(r3, n3, i3, o3);
              }(r2, u2, this, arguments[1], arguments[2], arguments[3]);
              break;
            default:
              for (i2 = new Array(n2 - 1), o2 = 1; o2 < n2; o2++) i2[o2 - 1] = arguments[o2];
              !function(e3, t3, r3, n3) {
                if (t3) e3.apply(r3, n3);
                else for (var i3 = e3.length, o3 = y(e3, i3), s3 = 0; s3 < i3; ++s3) o3[s3].apply(r3, n3);
              }(r2, u2, this, i2);
          }
          return true;
          ...
          if (r2 === t2 || r2.listener === t2) 0 == --this._eventsCount ? this._events = n(null) : (delete i2[e2], i2.removeListener && this.emit("removeListener", e2, r2.listener || t2));
          else if ("function" != typeof r2) {
            for (o2 = -1, s2 = r2.length - 1; s2 >= 0; s2--) if (r2[s2] === t2 || r2[s2].listener === t2) {
          ...
          else if (t2) for (o2 = t2.length - 1; o2 >= 0; o2--) this.removeListener(e2, t2[o2]);
          return this;
        ...
        var n = function() {
          ...
          return e2.prototype.rotateLeft = function() {
            ...
            if (!n2) throw new Error("unknown error");
            ...
            if (!r2) throw new Error("unknown error");
          ...
          function a(o2) {
            return function(a2) {
              return function(o3) {
                ...
                for (; s; ) try {
                  if (r2 = 1, n2 && (i2 = 2 & o3[0] ? n2.return : o3[0] ? n2.throw || ((i2 = n2.return) && i2.call(n2), 0) : n2.next) && !(i2 = i2.call(n2, o3[1])).done) return i2;
        ...
        function i(e2) {
          ...
          this.size = function() {
            ...
            if (!this.empty()) {
              var t3 = 0;
              if (o !== a) {
                for (u2 = s; u2 < i.bucketSize; ++u2) e3(r2[o][u2], t3++);
                for (u2 = o + 1; u2 < a; ++u2) for (var n2 = 0; n2 < i.bucketSize; ++n2) e3(r2[u2][n2], t3++);
                for (u2 = 0; u2 <= l; ++u2) e3(r2[a][u2], t3++);
              } else for (var u2 = s; u2 <= l; ++u2) e3(r2[o][u2], t3++);
            }
          };
          var h = function(e3) {
            var t3 = o * i.bucketSize + s, r3 = t3 + e3, n2 = a * i.bucketSize + l;
            if (r3 < t3 || r3 > n2) throw new Error("pos should more than 0 and less than queue's size");
          ...
          this.getElementByPos = function(e3) {
            ...
            var t3 = this;
            if (e3 < 0 || e3 > c) throw new Error("pos should more than 0 and less than queue's size");
            if (0 === e3) this.popFront();
            else if (e3 === this.size()) this.popBack();
            else {
              for (var r3 = [], n2 = e3 + 1; n2 < c; ++n2) r3.push(this.getElementByPos(n2));
            ...
            if (!this.empty()) {
              ...
              for (var r3 = t3.length, n2 = 0; n2 < r3; ++n2) this.setElementByPos(n2, t3[n2]);
              this.cut(r3 - 1);
            }
          };
          var f = function(e3) {
            for (var t3 = [], n2 = e3 * i.sigma, h2 = Math.max(Math.ceil(n2 / i.bucketSize), 2), f2 = 0; f2 < h2; ++f2) t3.push(new Array(i.bucketSize));
            var p = Math.ceil(e3 / i.bucketSize), d = Math.floor(h2 / 2) - Math.floor(p / 2), g = d, y = 0;
            if (this.size()) for (f2 = 0; f2 < p; ++f2) {
              for (var b = 0; b < i.bucketSize; ++b) if (t3[d + f2][b] = this.front(), this.popFront(), this.empty()) {
                g = d + f2, y = b;
                break;
              }
              if (this.empty()) break;
          ...
          this.pushBack = function(e3) {
            ...
            var n2 = this;
            if (void 0 === r3 && (r3 = 1), 0 === e3) for (; r3--; ) this.pushFront(t3);
            else if (e3 === this.size()) for (; r3--; ) this.pushBack(t3);
            else {
              for (var i2 = [], o2 = e3; o2 < c; ++o2) i2.push(this.getElementByPos(o2));
              this.cut(e3 - 1);
              for (o2 = 0; o2 < r3; ++o2) this.pushBack(t3);
            ...
            if (o === a) {
              for (var t3 = s; t3 <= l; ++t3) if (r2[o][t3] === e3) return true;
              return false;
            }
            for (t3 = s; t3 < i.bucketSize; ++t3) if (r2[o][t3] === e3) return true;
            for (t3 = o + 1; t3 < a; ++t3) for (var n2 = 0; n2 < i.bucketSize; ++n2) if (r2[t3][n2] === e3) return true;
            for (t3 = 0; t3 <= l; ++t3) if (r2[a][t3] === e3) return true;
            return false;
            ...
            if (!this.empty()) {
              ...
              for (var r3 = 0; r3 < c; ++r3) this.setElementByPos(r3, e3[r3]);
            ...
            for (var r3 = 0; r3 < c; ++r3) this.setElementByPos(r3, t3[r3]);
            ...
            var n2 = t3.length;
            r2 = [];
            for (var o2 = Math.ceil(n2 / i.bucketSize), s2 = 0; s2 < o2; ++s2) r2.push(new Array(i.bucketSize));
            ...
            for (var l2 = 0; l2 < u; ++l2) r2.push(new Array(i.bucketSize));
        ...
        function a(e2, t2, r2) {
          ...
          if (void 0 === e2 && (e2 = []), void 0 === t2 && (t2 = a.initSize), r2 = r2 || function(e3) {
            var t3, r3, n2 = 0, o2 = "";
            if ("number" == typeof e3) n2 = ((n2 = Math.floor(e3)) << 5) - n2, n2 &= n2;
            else {
            ...
            return n2 ^= n2 >>> 16;
          }, 0 != (t2 & t2 - 1)) throw new Error("initBucketNum must be 2 to the power of n");
          ...
          this.setElement = function(e3, t3) {
            var n2, l2;
            if (null === e3 || void 0 === e3) throw new Error("to avoid some unnecessary errors, we don't suggest you insert null or undefined here");
                ...
                if (c[f] instanceof o.default) {
                  try {
                    for (var d = i(c[f]), g = d.next(); !g.done; g = d.next()) {
                      var y = g.value;
                      if (y.key === e3) return void (y.value = t3);
                    }
                  } catch (e4) {
                    n2 = { error: e4 };
                  } finally {
            ...
            if (c[o2]) {
              if (c[o2] instanceof s.default) return c[o2].getElementByKey(e3);
              try {
                for (var a2 = i(c[o2]), l2 = a2.next(); !l2.done; l2 = a2.next()) {
                  var u2 = l2.value;
                  if (u2.key === e3) return u2.value;
                }
              } catch (e4) {
                t3 = { error: e4 };
              } finally {
            ...
            if (c[l2]) {
              var f = c[l2].size();
              if (c[l2] instanceof s.default) c[l2].eraseElementByKey(e3), c[l2].size() <= a.untreeifyThreshold && (c[l2] = new o.default(c[l2]));
              else {
                var p = -1;
                try {
            ...
            if (c[o2] instanceof s.default) return c[o2].find(e3);
            try {
              for (var a2 = i(c[o2]), l2 = a2.next(); !l2.done; l2 = a2.next()) {
                if (l2.value.key === e3) return true;
              }
            } catch (e4) {
              t3 = { error: e4 };
            } finally {
        ...
        function a(e2, t2, r2) {
          ...
          if (void 0 === e2 && (e2 = []), void 0 === t2 && (t2 = a.initSize), r2 = r2 || function(e3) {
            var t3 = 0, r3 = "";
            if ("number" == typeof e3) t3 = ((t3 = Math.floor(e3)) << 5) - t3, t3 &= t3;
            else {
                ...
                c.forEach(function(n3, i3) {
                  if (!n3.empty()) {
                    if (n3 instanceof s.default && 1 === n3.size()) {
                      var l2 = n3.front();
                      if (void 0 === l2) throw new Error("unknown error");
        ...
        function o(e2) {
          ...
          this.size = function() {
            ...
            for (var t3 = o2, r3 = 0; t3; ) {
              if (void 0 === t3.value) throw new Error("unknown error");
              e3(t3.value, r3++), t3 = t3.next;
            }
          }, this.getElementByPos = function(e3) {
            if (e3 < 0 || e3 >= r2) throw new Error("pos must more then 0 and less then the list length");
            for (var t3 = o2; e3-- && t3; ) t3 = t3.next;
            if (!t3 || void 0 === t3.value) throw new Error("unknown error");
            return t3.value;
          }, this.eraseElementByPos = function(e3) {
            if (e3 < 0 || e3 >= r2) throw new Error("erase pos must more then 0 and less then the list length");
            if (0 === e3) this.popFront();
            else if (e3 === r2 - 1) this.popBack();
            else {
              for (var t3 = o2; e3--; ) {
                if (!(null === t3 || void 0 === t3 ? void 0 : t3.next)) throw new Error("unknown error");
                t3 = t3.next;
              }
              if (!t3 || !t3.pre || !t3.next) throw new Error("unknown error");
              var n2 = t3.pre, i2 = t3.next;
              i2.pre = n2, n2.next = i2, r2 > 0 && --r2;
            }
          }, this.eraseElementByValue = function(e3) {
            for (; o2 && o2.value === e3; ) this.popFront();
            for (; s && s.value === e3; ) this.popBack();
            if (o2) for (var t3 = o2; t3; ) {
              if (t3.value === e3) {
                var n2 = t3.pre, i2 = t3.next;
            ...
            if (null === e3 || void 0 === e3) throw new Error("you can't push null or undefined here");
            ++r2;
            var t3 = new i(e3);
            ...
            if (null === t3 || void 0 === t3) throw new Error("you can't set null or undefined here");
            if (e3 < 0 || e3 >= r2) throw new Error("pos must more then 0 and less then the list length");
            for (var n2 = o2; e3--; ) {
              if (!n2) throw new Error("unknown error");
              n2 = n2.next;
            ...
            if (void 0 === n2 && (n2 = 1), null === t3 || void 0 === t3) throw new Error("you can't insert null or undefined here");
            if (e3 < 0 || e3 > r2) throw new Error("insert pos must more then 0 and less then or equal to the list length");
            if (n2 < 0) throw new Error("insert size must more than 0");
            if (0 === e3) for (; n2--; ) this.pushFront(t3);
            else if (e3 === r2) for (; n2--; ) this.pushBack(t3);
            else {
              for (var s2 = o2, a = 1; a < e3; ++a) {
                if (!(null === s2 || void 0 === s2 ? void 0 : s2.next)) throw new Error("unknown error");
                s2 = null === s2 || void 0 === s2 ? void 0 : s2.next;
              }
              if (!s2) throw new Error("unknown error");
              var l = s2.next;
              for (r2 += n2; n2--; ) s2.next = new i(t3), s2.next.pre = s2, s2 = s2.next;
              s2.next = l, l && (l.pre = s2);
            }
          }, this.find = function(e3) {
            for (var t3 = o2; t3; ) {
              if (t3.value === e3) return true;
              t3 = t3.next;
            }
            return false;
          }, this.reverse = function() {
            ...
            for (var e3 = o2; e3; ) {
              for (var t3 = e3; t3 && t3.next && t3.value === t3.next.value; ) t3 = t3.next, r2 > 0 && --r2;
            ...
            e3.forEach(function(e4) {
              for (; n2 && void 0 !== n2.value && n2.value <= e4; ) n2 = n2.next;
              if (void 0 === n2) t3.pushBack(e4), n2 = s;
              else if (n2 === o2) t3.pushFront(e4), n2 = o2;
              else {
                ++r2;
                var a = n2.pre;
              ...
              return n(this, function(t3) {
                switch (t3.label) {
                  case 0:
                    e3 = o2, t3.label = 1;
                  case 1:
                    if (void 0 === e3) return [3, 3];
                    if (!e3.value) throw new Error("unknown error");
                    return [4, e3.value];
                  case 2:
        ...
        function s(e2, t2) {
          ...
          var l = function(e3) {
            if (!e3 || void 0 === e3.key) throw new Error("unknown error");
          ...
          this.front = function() {
            if (!this.empty()) {
              var e3 = l(a);
              if (void 0 === e3.key || void 0 === e3.value) throw new Error("unknown error");
            ...
            var t3, r3;
            if (e3 < 0 || e3 >= this.size()) throw new Error("pos must more than 0 and less than set's size");
            var n2 = 0;
            try {
              for (var o2 = i(this), s3 = o2.next(); !s3.done; s3 = o2.next()) {
                var a2 = s3.value;
          ...
          var h = function(e3, r3) {
            if (e3 && void 0 !== e3.key && void 0 !== e3.value) return t2(e3.key, r3) <= 0 ? h(e3.rightChild, r3) : h(e3.leftChild, r3) || { key: e3.key, value: e3.value };
          };
          ...
          var p = function(e3, r3) {
            if (e3 && void 0 !== e3.key && void 0 !== e3.value) return t2(e3.key, r3) >= 0 ? p(e3.leftChild, r3) : p(e3.rightChild, r3) || { key: e3.key, value: e3.value };
          };
          ...
          var d = function(e3) {
            ...
            if (e3.color !== o.default.TreeNodeColorType.red) {
              ...
              if (e3 === t3.leftChild) {
                if (r3.color === o.default.TreeNodeColorType.red) {
                  ...
                  a === t3 && (a = n2), d(e3);
                } else if (r3.color === o.default.TreeNodeColorType.black) if (r3.rightChild && r3.rightChild.color === o.default.TreeNodeColorType.red) {
                ...
                } else if (r3.rightChild && r3.rightChild.color !== o.default.TreeNodeColorType.black || !r3.leftChild || r3.leftChild.color !== o.default.TreeNodeColorType.red) r3.leftChild && r3.leftChild.color !== o.default.TreeNodeColorType.black || r3.rightChild && r3.rightChild.color !== o.default.TreeNodeColorType.black || (r3.color = o.default.TreeNodeColorType.red, d(t3));
                else {
                ...
                if (r3.color === o.default.TreeNodeColorType.red) {
                  ...
                  n2 = t3.rotateRight();
                  a === t3 && (a = n2), d(e3);
                } else if (r3.color === o.default.TreeNodeColorType.black) if (r3.leftChild && r3.leftChild.color === o.default.TreeNodeColorType.red) {
                  ...
                  n2 = t3.rotateRight();
                  a === t3 && (a = n2), e3.color = o.default.TreeNodeColorType.black;
                } else if (r3.leftChild && r3.leftChild.color !== o.default.TreeNodeColorType.black || !r3.rightChild || r3.rightChild.color !== o.default.TreeNodeColorType.red) r3.leftChild && r3.leftChild.color !== o.default.TreeNodeColorType.black || r3.rightChild && r3.rightChild.color !== o.default.TreeNodeColorType.black || (r3.color = o.default.TreeNodeColorType.red, d(t3));
                else {
            ...
            } else e3.color = o.default.TreeNodeColorType.black;
          }, g = function(e3) {
          ...
          this.eraseElementByPos = function(e3) {
            if (e3 < 0 || e3 >= s2) throw new Error("pos must more than 0 and less than set's size");
            var t3 = 0;
            y(a, function(r3) {
          ...
          var b = function(e3, r3) {
            ...
            if (t3.color !== o.default.TreeNodeColorType.black && t3.color === o.default.TreeNodeColorType.red) {
              ...
              if (!n2) throw new Error("unknown error");
              if (r3 && r3.color === o.default.TreeNodeColorType.red) r3.color = t3.color = o.default.TreeNodeColorType.black, n2.color = o.default.TreeNodeColorType.red, m(n2);
          ...
          this.setElement = function(e3, r3) {
            ...
            if (null !== r3 && void 0 !== r3) {
              if (this.empty()) return ++s2, a.key = e3, a.value = r3, void (a.color = o.default.TreeNodeColorType.black);
              var n2 = b(a, e3);
          ...
          this.find = function(e3) {
            ...
            var t3 = v(a, e3);
            if (void 0 === (null === t3 || void 0 === t3 ? void 0 : t3.key) || void 0 === (null === t3 || void 0 === t3 ? void 0 : t3.value)) throw new Error("unknown error");
            return t3.value;
        ...
        function n(e2, t2) {
          ...
          var n2 = r2.length, i = function(e3, t3) {
            if (e3 < 0 || e3 >= n2) throw new Error("unknown error");
            if (t3 < 0 || t3 >= n2) throw new Error("unknown error");
            var i2 = r2[e3];
          ...
          !function() {
            for (var e3 = Math.floor((n2 - 1) / 2); e3 >= 0; --e3) for (var o2 = e3, s = 2 * o2 + 1; s < n2; ) {
              var a = s + 1, l = s;
              if (a < n2 && t2(r2[s], r2[a]) > 0 && (l = a), t2(r2[o2], r2[l]) <= 0) break;
              i(o2, l), s = 2 * (o2 = l) + 1;
            }
          }(), this.size = function() {
            return n2;
            ...
            if (r2.push(e3), 1 !== ++n2) for (var i2 = n2 - 1; i2 > 0; ) {
              var s = Math.floor((i2 - 1) / 2);
              if (t2(r2[s], e3) <= 0) break;
              o(s), i2 = s;
            }
          }, this.pop = function() {
            if (!this.empty()) if (1 !== this.size()) {
              ...
              for (var i2 = 0; i2 < this.size(); ) {
                ...
                if (o2 >= this.size()) break;
                var a = o2;
                if (s < this.size() && t2(r2[o2], r2[s]) > 0 && (a = s), t2(r2[a], e3) >= 0) break;
                r2[i2] = r2[a], i2 = a;
              }
              r2[i2] = e3;
            } else --n2;
        ...
        function s(e2, t2) {
            ...
            if (e3.color !== o.default.TreeNodeColorType.red) {
              ...
              if (e3 === t3.leftChild) {
                if (r3.color === o.default.TreeNodeColorType.red) {
                  ...
                  n2 = t3.rotateLeft();
                  a === t3 && (a = n2), e3.color = o.default.TreeNodeColorType.black;
                } else if (r3.rightChild && r3.rightChild.color !== o.default.TreeNodeColorType.black || !r3.leftChild || r3.leftChild.color !== o.default.TreeNodeColorType.red) r3.leftChild && r3.leftChild.color !== o.default.TreeNodeColorType.black || r3.rightChild && r3.rightChild.color !== o.default.TreeNodeColorType.black || (r3.color = o.default.TreeNodeColorType.red, c(t3));
                else {
                  r3.color = o.default.TreeNodeColorType.red, r3.leftChild && (r3.leftChild.color = o.default.TreeNodeColorType.black);
                  n2 = r3.rotateRight();
                  a === r3 && (a = n2), c(e3);
          ...
          var p = function(e3, r3) {
            ...
            if (t3.color !== o.default.TreeNodeColorType.black && t3.color === o.default.TreeNodeColorType.red) {
              var r3 = t3.brother, n2 = t3.parent;
              if (!n2) throw new Error("unknown error");
              if (r3 && r3.color === o.default.TreeNodeColorType.red) r3.color = t3.color = o.default.TreeNodeColorType.black, n2.color = o.default.TreeNodeColorType.red, d(n2);
              else if (!r3 || r3.color === o.default.TreeNodeColorType.black) {
                if (t3 === n2.leftChild) {
                  if (e3 === t3.leftChild) {
                    t3.color = o.default.TreeNodeColorType.black, n2.color = o.default.TreeNodeColorType.red;
          ...
          this.insert = function(e3) {
            if (null === e3 || void 0 === e3) throw new Error("to avoid some unnecessary errors, we don't suggest you insert null or undefined here");
            if (this.empty()) return ++s2, a.key = e3, void (a.color = o.default.TreeNodeColorType.black);
            var r3 = p(a, e3);
          ...
          var y = function(e3, r3) {
            if (e3 && void 0 !== e3.key) {
              var n2 = t2(e3.key, r3);
              if (0 === n2) return e3.key;
              if (n2 < 0) return y(e3.rightChild, r3);
          ...
          var b = function(e3, r3) {
            if (e3 && void 0 !== e3.key) {
              if (t2(e3.key, r3) <= 0) return b(e3.rightChild, r3);
          ...
          var m = function(e3, r3) {
            if (e3 && void 0 !== e3.key) {
              var n2 = t2(e3.key, r3);
              if (0 === n2) return e3.key;
              if (n2 > 0) return m(e3.leftChild, r3);
          ...
          var v = function(e3, r3) {
            if (e3 && void 0 !== e3.key) {
              if (t2(e3.key, r3) >= 0) return v(e3.leftChild, r3);
        ...
        function a(e2) {
          ...
          this.size = function() {
            ...
            if (!this.empty()) return a2[0];
          }, this.back = function() {
            if (!this.empty()) return a2[r2 - 1];
          }, this.forEach = function(e3) {
            a2.forEach(e3);
          }, this.getElementByPos = function(e3) {
            if (e3 < 0 || e3 >= r2) throw new Error("pos must more than 0 and less than vector's size");
            return a2[e3];
          }, this.eraseElementByPos = function(e3) {
            if (e3 < 0 || e3 >= r2) throw new Error("pos must more than 0 and less than vector's size");
            for (var t3 = e3; t3 < r2 - 1; ++t3) a2[t3] = a2[t3 + 1];
            this.popBack();
          }, this.eraseElementByValue = function(e3) {
            var t3 = [];
            ...
            for (var n2 = t3.length; r2 > n2; ) this.popBack();
          }, this.pushBack = function(e3) {
            a2.push(e3), ++r2;
          }, this.popBack = function() {
            a2.pop(), r2 > 0 && --r2;
            ...
            if (void 0 === n2 && (n2 = 1), e3 < 0 || e3 > r2) throw new Error("pos must more than 0 and less than or equal to vector's size");
        ...
        const g = (e2, t2, r2) => {
          ...
          if (n2) {
            const t3 = n2.value;
            if (y(e2, t3)) {
              if (m(e2, n2), !e2[a]) return;
            } else r2 && (e2[p] && (n2.value.now = Date.now()), e2[h].unshiftNode(n2));
            return t3.value;
          }
        }, y = (e2, t2) => {
          if (!t2 || !t2.maxAge && !e2[l]) return false;
          const r2 = Date.now() - t2.now;
          return t2.maxAge ? r2 > t2.maxAge : e2[l] && r2 > e2[l];
        }, b = (e2) => {
          if (e2[o] > e2[i]) for (let t2 = e2[h].tail; e2[o] > e2[i] && null !== t2; ) {
            const r2 = t2.prev;
            m(e2, t2), t2 = r2;
          }
        }, m = (e2, t2) => {
        ...
        t.exports = class {
          constructor(e2) {
            if ("number" == typeof e2 && (e2 = { max: e2 }), e2 || (e2 = {}), e2.max && ("number" != typeof e2.max || e2.max < 0)) throw new TypeError("max must be a non-negative number");
            this[i] = e2.max || 1 / 0;
            const t2 = e2.length || d;
            if (this[s] = "function" != typeof t2 ? d : t2, this[a] = e2.stale || false, e2.maxAge && "number" != typeof e2.maxAge) throw new TypeError("maxAge must be a number");
            this[l] = e2.maxAge || 0, this[u] = e2.dispose, this[c] = e2.noDisposeOnSet || false, this[p] = e2.updateAgeOnGet || false, this.reset();
          }
          set max(e2) {
            if ("number" != typeof e2 || e2 < 0) throw new TypeError("max must be a non-negative number");
          ...
          set maxAge(e2) {
            if ("number" != typeof e2) throw new TypeError("maxAge must be a non-negative number");
            this[l] = e2, b(this);
          }
          get maxAge() {
            return this[l];
          ...
          set(e2, t2, r2) {
            if ((r2 = r2 || this[l]) && "number" != typeof r2) throw new TypeError("maxAge must be a number");
            const n2 = r2 ? Date.now() : 0, a2 = this[s](t2, e2);
            if (this[f].has(e2)) {
              if (a2 > this[i]) return m(this, this[f].get(e2)), false;
          ...
          (function() {
            ...
            class o extends i {
              ...
              concat() {
                ...
                let i2, o2 = 0;
                for (i2 = 0; i2 < n2.length && void 0 !== n2[i2]; i2++) "string" != typeof n2[i2] ? t2[i2] = n2[i2].length : t2[i2] = r2.byteLength(n2[i2]), e2 += t2[i2];
                const s = r2.allocUnsafe(e2);
                for (i2 = 0; i2 < n2.length && void 0 !== n2[i2]; i2++) "string" != typeof n2[i2] ? (n2[i2].copy(s, o2), o2 += t2[i2]) : (s.write(n2[i2], o2), o2 += t2[i2]);
                return s;
              }
            }
            t.exports = function(e2, t2) {
        ...
        (function(e2) {
          (function() {
            ...
            t.exports = { cache: n, generateCache: function() {
              for (let e3 = 0; e3 < r2; e3++) n[e3] = o(e3);
        ...
        class l extends i {
          ...
          _parseConnect() {
            ...
            if (null === l2) return this._emitError(new Error("Cannot parse protocolId"));
            if ("MQTT" !== l2 && "MQIsdp" !== l2) return this._emitError(new Error("Invalid protocolId"));
            if (o2.protocolId = l2, this._pos >= this._list.length) return this._emitError(new Error("Packet too short"));
            ...
            if (o2.clientId = u, a("_parseConnect: packet.clientId: %s", o2.clientId), i2.will) {
              ...
              if (null === (e2 = this._parseString())) return this._emitError(new Error("Cannot parse will topic"));
              if (o2.will.topic = e2, a("_parseConnect: packet.will.topic: %s", o2.will.topic), null === (t2 = this._parseBuffer())) return this._emitError(new Error("Cannot parse will payload"));
              o2.will.payload = t2, a("_parseConnect: packet.will.paylaod: %s", o2.will.payload);
            }
            if (i2.username) {
              if (null === (n2 = this._parseString())) return this._emitError(new Error("Cannot parse username"));
              o2.username = n2, a("_parseConnect: packet.username: %s", o2.username);
            }
            if (i2.password) {
              if (null === (r2 = this._parseBuffer())) return this._emitError(new Error("Cannot parse password"));
              o2.password = r2;
            }
          ...
          _parseConnack() {
            ...
            if (e2.sessionPresent = !!(this._list.readUInt8(this._pos++) & s.SESSIONPRESENT_MASK), 5 === this.settings.protocolVersion) this._list.length >= 2 ? e2.reasonCode = this._list.readUInt8(this._pos++) : e2.reasonCode = 0;
            else {
              if (this._list.length < 2) return null;
              e2.returnCode = this._list.readUInt8(this._pos++);
            }
            if (-1 === e2.returnCode || -1 === e2.reasonCode) return this._emitError(new Error("Cannot parse return code"));
          ...
          _parsePublish() {
            a("_parsePublish");
            const e2 = this.packet;
            if (e2.topic = this._parseString(), null === e2.topic) return this._emitError(new Error("Cannot parse topic"));
          ...
          _parseSubscribe() {
            ...
            if (1 !== e2.qos) return this._emitError(new Error("Wrong subscribe header"));
            if (e2.subscriptions = [], this._parseMessageId()) {
              ...
              for (; this._pos < e2.length; ) {
                if (null === (t2 = this._parseString())) return this._emitError(new Error("Cannot parse topic"));
                if (this._pos >= e2.length) return this._emitError(new Error("Malformed Subscribe Payload"));
          ...
          _parseUnsubscribe() {
            ...
            if (e2.unsubscriptions = [], this._parseMessageId()) {
              ...
              for (; this._pos < e2.length; ) {
                ...
                if (null === t2) return this._emitError(new Error("Cannot parse topic"));
          ...
          _parseUnsuback() {
            ...
            if (5 === this.settings.protocolVersion) {
              const t2 = this._parseProperties();
              for (Object.getOwnPropertyNames(t2).length && (e2.properties = t2), e2.granted = []; this._pos < this.packet.length; ) this.packet.granted.push(this._list.readUInt8(this._pos++));
            }
          }
          _parseConfirmation() {
          ...
          _parseString(e2) {
            ...
            if (-1 === t2 || r2 > this._list.length || r2 > this.packet.length) return null;
          ...
          _parseBuffer() {
            ...
            if (-1 === e2 || t2 > this._list.length || t2 > this.packet.length) return null;
          ...
          _parseProperties() {
            ...
            for (; this._pos < t2; ) {
              ...
              if (!e3) return this._emitError(new Error("Cannot parse property code type")), false;
              const t3 = s.propertiesCodes[e3];
              if (!t3) return this._emitError(new Error("Unknown property")), false;
              if ("userProperties" !== t3) r2[t3] ? Array.isArray(r2[t3]) ? r2[t3].push(this._parseByType(s.propertiesTypes[t3])) : (r2[t3] = [r2[t3]], r2[t3].push(this._parseByType(s.propertiesTypes[t3]))) : r2[t3] = this._parseByType(s.propertiesTypes[t3]);
              else {
                r2[t3] || (r2[t3] = /* @__PURE__ */ Object.create(null));
                const e4 = this._parseByType(s.propertiesTypes[t3]);
                if (r2[t3][e4.name]) if (Array.isArray(r2[t3][e4.name])) r2[t3][e4.name].push(e4.value);
                else {
                  const n2 = r2[t3][e4.name];
                  r2[t3][e4.name] = [n2], r2[t3][e4.name].push(e4.value);
                }
                else r2[t3][e4.name] = e4.value;
              }
            }
            return r2;
          }
        ...
        (function(r2) {
          (function() {
              ...
              switch (l("generate called"), t2.cork && (t2.cork(), a(b, t2)), g && (g = false, h()), l("generate: packet.cmd: %s", e2.cmd), e2.cmd) {
                case "connect":
                  return function(e3, t3, i2) {
                    ...
                    void 0 === u2 && (u2 = true);
                    let y2 = 0;
                    if (!s3 || "string" != typeof s3 && !r2.isBuffer(s3)) return t3.emit("error", new Error("Invalid protocolId")), false;
                    y2 += s3.length + 2;
                    if (3 !== a2 && 4 !== a2 && 5 !== a2) return t3.emit("error", new Error("Invalid protocol version")), false;
                    y2 += 1;
                    if (("string" == typeof h2 || r2.isBuffer(h2)) && (h2 || a2 >= 4) && (h2 || u2)) y2 += r2.byteLength(h2) + 2;
                    else {
                      if (a2 < 4) return t3.emit("error", new Error("clientId must be supplied before 3.1.1")), false;
                      if (1 * u2 == 0) return t3.emit("error", new Error("clientId must be given if cleanSession set to 0")), false;
                    }
                    if ("number" != typeof c2 || c2 < 0 || c2 > 65535 || c2 % 1 != 0) return t3.emit("error", new Error("Invalid keepalive")), false;
                    y2 += 2;
                    if (y2 += 1, 5 === a2) {
                      var b2 = C(t3, g2);
                      if (!b2) return false;
                    ...
                    if (l2) {
                      if ("object" != typeof l2) return t3.emit("error", new Error("Invalid will")), false;
                      if (!l2.topic || "string" != typeof l2.topic) return t3.emit("error", new Error("Invalid will topic")), false;
                      if (y2 += r2.byteLength(l2.topic) + 2, y2 += 2, l2.payload) {
                        if (!(l2.payload.length >= 0)) return t3.emit("error", new Error("Invalid will payload")), false;
                        "string" == typeof l2.payload ? y2 += r2.byteLength(l2.payload) : y2 += l2.payload.length;
                      }
                      var m2 = {};
                      if (5 === a2) {
                        if (!(m2 = C(t3, l2.properties))) return false;
                        y2 += m2.length;
                      }
                    }
                    let _2 = false;
                    if (null != f2) {
                      if (!P(f2)) return t3.emit("error", new Error("Invalid username")), false;
                      _2 = true, y2 += r2.byteLength(f2) + 2;
                    }
                    if (null != p2) {
                      if (!_2) return t3.emit("error", new Error("Username is required to use password")), false;
                      if (!P(p2)) return t3.emit("error", new Error("Invalid password")), false;
                      y2 += I(p2) + 2;
                    }
                ...
                case "connack":
                  return function(e3, t3, i2) {
                    ...
                    let c2 = 2;
                    if ("number" != typeof l2) return t3.emit("error", new Error("Invalid return code")), false;
                    let h2 = null;
                    if (5 === s3) {
                      if (!(h2 = C(t3, u2))) return false;
                      c2 += h2.length;
                    }
                ...
                case "publish":
                  return function(e3, t3, o2) {
                    ...
                    let y2 = 0;
                    if ("string" == typeof h2) y2 += r2.byteLength(h2) + 2;
                    else {
                      if (!r2.isBuffer(h2)) return t3.emit("error", new Error("Invalid topic")), false;
                      y2 += h2.length + 2;
                    }
                    r2.isBuffer(f2) ? y2 += f2.length : y2 += r2.byteLength(f2);
                    if (u2 && "number" != typeof p2) return t3.emit("error", new Error("Invalid messageId")), false;
                    u2 && (y2 += 2);
                    let b2 = null;
                    if (5 === s3) {
                      if (!(b2 = C(t3, g2))) return false;
                      y2 += b2.length;
                    }
                ...
                case "pubcomp":
                  return function(e3, t3, i2) {
                    ...
                    let p2 = 5 === o2 ? 3 : 2;
                    "pubrel" === a2 && (c2 = 1);
                    if ("number" != typeof l2) return t3.emit("error", new Error("Invalid messageId")), false;
                    let g2 = null;
                    if (5 === o2 && "object" == typeof f2) {
                      if (!(g2 = T(t3, f2, i2, p2))) return false;
                      p2 += g2.length;
                    }
                ...
                case "subscribe":
                  return function(e3, t3, i2) {
                    ...
                    let f2 = 0;
                    if ("number" != typeof u2) return t3.emit("error", new Error("Invalid messageId")), false;
                    f2 += 2;
                    let p2 = null;
                    if (5 === o2) {
                      if (!(p2 = C(t3, h2))) return false;
                      f2 += p2.length;
                    }
                    if ("object" != typeof c2 || !c2.length) return t3.emit("error", new Error("Invalid subscriptions")), false;
                    for (let e4 = 0; e4 < c2.length; e4 += 1) {
                      const n2 = c2[e4].topic, i3 = c2[e4].qos;
                      if ("string" != typeof n2) return t3.emit("error", new Error("Invalid subscriptions - invalid topic")), false;
                      if ("number" != typeof i3) return t3.emit("error", new Error("Invalid subscriptions - invalid qos")), false;
                      if (5 === o2) {
                        const r3 = c2[e4].nl || false;
                        if ("boolean" != typeof r3) return t3.emit("error", new Error("Invalid subscriptions - invalid No Local")), false;
                        const n3 = c2[e4].rap || false;
                        if ("boolean" != typeof n3) return t3.emit("error", new Error("Invalid subscriptions - invalid Retain as Published")), false;
                        const i4 = c2[e4].rh || 0;
                        if ("number" != typeof i4 || i4 > 2) return t3.emit("error", new Error("Invalid subscriptions - invalid Retain Handling")), false;
                      }
                ...
                case "suback":
                  return function(e3, t3, i2) {
                    ...
                    let c2 = 0;
                    if ("number" != typeof a2) return t3.emit("error", new Error("Invalid messageId")), false;
                    c2 += 2;
                    if ("object" != typeof l2 || !l2.length) return t3.emit("error", new Error("Invalid qos vector")), false;
                    for (let e4 = 0; e4 < l2.length; e4 += 1) {
                      if ("number" != typeof l2[e4]) return t3.emit("error", new Error("Invalid qos vector")), false;
                      c2 += 1;
                    }
                    let h2 = null;
                    if (5 === o2) {
                      if (!(h2 = T(t3, u2, i2, c2))) return false;
                      c2 += h2.length;
                    }
                ...
                case "unsubscribe":
                  return function(e3, t3, i2) {
                    ...
                    if ("number" != typeof a2) return t3.emit("error", new Error("Invalid messageId")), false;
                    h2 += 2;
                    if ("object" != typeof u2 || !u2.length) return t3.emit("error", new Error("Invalid unsubscriptions")), false;
                    for (let e4 = 0; e4 < u2.length; e4 += 1) {
                      if ("string" != typeof u2[e4]) return t3.emit("error", new Error("Invalid unsubscriptions")), false;
                      h2 += r2.byteLength(u2[e4]) + 2;
                    }
                    let f2 = null;
                    if (5 === o2) {
                      if (!(f2 = C(t3, c2))) return false;
                      h2 += f2.length;
                    }
                    t3.write(n.UNSUBSCRIBE_HEADER[1][l2 ? 1 : 0][0]), v(t3, h2), d(t3, a2), null !== f2 && f2.write();
                    let p2 = true;
                    for (let e4 = 0; e4 < u2.length; e4++) p2 = w(t3, u2[e4]);
                    return p2;
                  }(e2, t2, s2);
                case "unsuback":
                  return function(e3, t3, i2) {
                    ...
                    if ("number" != typeof a2) return t3.emit("error", new Error("Invalid messageId")), false;
                    if (5 === o2) {
                      if ("object" != typeof u2 || !u2.length) return t3.emit("error", new Error("Invalid qos vector")), false;
                      for (let e4 = 0; e4 < u2.length; e4 += 1) {
                        if ("number" != typeof u2[e4]) return t3.emit("error", new Error("Invalid qos vector")), false;
                        f2 += 1;
                      }
                    }
                    let p2 = null;
                    if (5 === o2) {
                      if (!(p2 = T(t3, c2, i2, f2))) return false;
                      f2 += p2.length;
                    }
                ...
                case "disconnect":
                  return function(e3, t3, i2) {
                    ...
                    if (5 === o2) {
                      if (!(c2 = T(t3, l2, i2, u2))) return false;
                      u2 += c2.length;
                    }
            ...
            const m = {};
            function v(e2, t2) {
              if (t2 > n.VARBYTEINT_MAX) return e2.emit("error", new Error(`Invalid variable byte integer: ${t2}`)), false;
              let r3 = m[t2];
            ...
            function C(e2, t2) {
              if ("object" != typeof t2 || null != t2.length) return { length: 1, write() {
                A(e2, {}, 0);
              } };
              let i2 = 0;
              function o2(t3, i3) {
                ...
                switch (n.propertiesTypes[t3]) {
                  case "byte":
                    if ("boolean" != typeof i3) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 2;
                    break;
                  case "int8":
                    if ("number" != typeof i3 || i3 < 0 || i3 > 255) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 2;
                    break;
                  case "binary":
                    if (i3 && null === i3) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 1 + r2.byteLength(i3) + 2;
                    break;
                  case "int16":
                    if ("number" != typeof i3 || i3 < 0 || i3 > 65535) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 3;
                    break;
                  case "int32":
                    if ("number" != typeof i3 || i3 < 0 || i3 > 4294967295) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 5;
                    break;
                  case "var":
                    if ("number" != typeof i3 || i3 < 0 || i3 > 268435455) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 1 + r2.byteLength(f(i3));
                    break;
                  case "string":
                    if ("string" != typeof i3) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
                    o3 += 3 + r2.byteLength(i3.toString());
                    break;
                  case "pair":
                    if ("object" != typeof i3) return e2.emit("error", new Error(`Invalid ${t3}: ${i3}`)), false;
              ...
              if (t2) for (const e3 in t2) {
                let r3 = 0, n2 = 0;
                const s2 = t2[e3];
                if (Array.isArray(s2)) for (let t3 = 0; t3 < s2.length; t3++) {
                  if (!(n2 = o2(e3, s2[t3]))) return false;
                  r3 += n2;
                }
                else {
                  if (!(n2 = o2(e3, s2))) return false;
                  r3 = n2;
                }
                if (!r3) return false;
                i2 += r3;
            ...
            function T(e2, t2, r3, n2) {
              ...
              let s2 = C(e2, t2);
              if (o2) for (; n2 + s2.length > o2; ) {
                const r4 = i2.shift();
                if (!r4 || !t2[r4]) return false;
            ...
            function A(e2, t2, r3) {
              v(e2, r3);
              for (const r4 in t2) if (Object.prototype.hasOwnProperty.call(t2, r4) && null !== t2[r4]) {
                const n2 = t2[r4];
                if (Array.isArray(n2)) for (let t3 = 0; t3 < n2.length; t3++) x(e2, r4, n2[t3]);
                else x(e2, r4, n2);
              }
            }
            function I(e2) {
        ...
        t.exports = function(e2, t2) {
          ...
          if ("number" === r2 && isFinite(e2)) return t2.long ? function(e3) {
            var t3 = Math.abs(e3);
            if (t3 >= s) return u(e3, t3, s, "day");
            if (t3 >= o) return u(e3, t3, o, "hour");
            if (t3 >= i) return u(e3, t3, i, "minute");
            if (t3 >= n) return u(e3, t3, n, "second");
            return e3 + " ms";
          }(e2) : function(e3) {
            var t3 = Math.abs(e3);
            if (t3 >= s) return Math.round(e3 / s) + "d";
            if (t3 >= o) return Math.round(e3 / o) + "h";
            if (t3 >= i) return Math.round(e3 / i) + "m";
            if (t3 >= n) return Math.round(e3 / n) + "s";
            return e3 + "ms";
          }(e2);
        ...
        function a(e2, t2) {
          if (!(this instanceof a)) return new a(e2, t2);
        ...
        s.prototype.equals = function(e2) {
          ...
          if (r2) {
            if (r2.equals(t2)) return this.ss.eraseElementByValue(r2), i("use():" + e2), true;
            if (r2.low > e2) return false;
            if (r2.low === e2) return ++r2.low, i("use():" + e2), true;
            if (r2.high === e2) return --r2.high, i("use():" + e2), true;
            const n2 = r2.low;
            return r2.low = e2 + 1, this.ss.insert(new s(n2, e2 - 1)), i("use():" + e2), true;
          }
          return i("use():failed"), false;
        }, a.prototype.free = function(e2) {
          if (e2 < this.min || e2 > this.max) return void o("free():" + e2 + " is out of range");
          const t2 = new s(e2, e2), r2 = this.ss.lowerBound(t2);
          if (r2) {
            if (r2.low <= e2 && e2 <= r2.high) return void o("free():" + e2 + " has already been vacant");
            if (r2 === this.ss.front()) e2 + 1 === r2.low ? --r2.low : this.ss.insert(t2);
            else {
            ...
            if (r2 === this.ss.front()) return void this.ss.insert(t2);
            const n2 = this.ss.reverseLowerBound(t2);
          ...
          for (const e2 of this.ss) console.log(e2);
        }, t.exports = a;
        ...
        function l(e2) {
          ...
          if ((n === s || !n) && setTimeout) return n = setTimeout, setTimeout(e2, 0);
          try {
            return n(e2, 0);
          } catch (t2) {
            try {
        ...
        (function(e2) {
          (function() {
            !function(n) {
              ...
              function O(e3, t2, r2) {
                var n2 = 0;
                for (e3 = r2 ? S(e3 / d) : e3 >> 1, e3 += S(e3 / t2); e3 > k * f >> 1; n2 += c) e3 = S(e3 / k);
                return S(n2 + (k + 1) * e3 / (e3 + p));
              }
              function B(e3) {
                var t2, r2, n2, i2, o2, s2, a2, l2, p2, d2, m2, v2 = [], w2 = e3.length, _2 = 0, k2 = y, E2 = g;
                for ((r2 = e3.lastIndexOf(b)) < 0 && (r2 = 0), n2 = 0; n2 < r2; ++n2) e3.charCodeAt(n2) >= 128 && C("not-basic"), v2.push(e3.charCodeAt(n2));
                for (i2 = r2 > 0 ? r2 + 1 : 0; i2 < w2; ) {
                  for (o2 = _2, s2 = 1, a2 = c; i2 >= w2 && C("invalid-input"), ((l2 = (m2 = e3.charCodeAt(i2++)) - 48 < 10 ? m2 - 22 : m2 - 65 < 26 ? m2 - 65 : m2 - 97 < 26 ? m2 - 97 : c) >= c || l2 > S((u - _2) / s2)) && C("overflow"), _2 += l2 * s2, !(l2 < (p2 = a2 <= E2 ? h : a2 >= E2 + f ? f : a2 - E2)); a2 += c) s2 > S(u / (d2 = c - p2)) && C("overflow"), s2 *= d2;
              ...
              function R(e3) {
                ...
                for (v2 = (e3 = A(e3)).length, t2 = y, r2 = 0, o2 = g, s2 = 0; s2 < v2; ++s2) (m2 = e3[s2]) < 128 && T2.push(E(m2));
                for (n2 = i2 = T2.length, i2 && T2.push(b); n2 < v2; ) {
                  for (a2 = u, s2 = 0; s2 < v2; ++s2) (m2 = e3[s2]) >= t2 && m2 < a2 && (a2 = m2);
                  for (a2 - t2 > S((u - r2) / (w2 = n2 + 1)) && C("overflow"), r2 += (a2 - t2) * w2, t2 = a2, s2 = 0; s2 < v2; ++s2) if ((m2 = e3[s2]) < t2 && ++r2 > u && C("overflow"), m2 == t2) {
                    for (l2 = r2, p2 = c; !(l2 < (d2 = p2 <= o2 ? h : p2 >= o2 + f ? f : p2 - o2)); p2 += c) k2 = l2 - d2, _2 = c - d2, T2.push(E(P(d2 + k2 % _2, 0))), l2 = S(k2 / _2);
              ...
              } }, i && o) if (t.exports == i) o.exports = a;
              else for (l in a) a.hasOwnProperty(l) && (i[l] = a[l]);
              else n.punycode = a;
            }(this);
          }).call(this);
        ...
        t.exports = function(e2, t2, r2, o) {
          t2 = t2 || "&", r2 = r2 || "=";
          var s = {};
          if ("string" != typeof e2 || 0 === e2.length) return s;
          var a = /\+/g;
          e2 = e2.split(t2);
          var l = 1e3;
        ...
        i("ERR_INVALID_OPT_VALUE", function(e2, t2) {
          ...
          }(e2, " argument")) a = "The ".concat(e2, " ").concat(n2, " ").concat(o(t2, "type"));
          else {
        ...
        (function(r2, n) {
          (function() {
            ...
            function C(t2) {
              if (i = i || e("./_stream_duplex"), !(this instanceof C)) return new C(t2);
            ...
            function T(e2, t2, r3, n2, i2) {
              ...
              if (null === t2) s2.reading = false, function(e3, t3) {
                if (u("onEofChunk"), t3.ended) return;
                if (t3.decoder) {
              ...
              else if (s2.objectMode || t2 && t2.length > 0) if ("string" == typeof t2 || s2.objectMode || Object.getPrototypeOf(t2) === a.prototype || (t2 = function(e3) {
                return a.from(e3);
              }(t2)), n2) s2.endEmitted ? k(e2, new _()) : x(e2, s2, t2, true);
              else if (s2.ended) k(e2, new v());
              else {
                if (s2.destroyed) return false;
              ...
              else n2 || (s2.reading = false, B(e2, s2));
            ...
            function R(e2, t2) {
              for (; !t2.reading && !t2.ended && (t2.length < t2.highWaterMark || t2.flowing && 0 === t2.length); ) {
                var r3 = t2.length;
                if (u("maybeReadMore read 0"), e2.read(0), r3 === t2.length) break;
              }
            ...
            C.prototype.read = function(e2) {
              ...
              if (0 !== e2 && (t2.emittedReadable = false), 0 === e2 && t2.needReadable && ((0 !== t2.highWaterMark ? t2.length >= t2.highWaterMark : t2.length > 0) || t2.ended)) return u("read: emitReadable", t2.length, t2.ended), 0 === t2.length && t2.ended ? q(this) : P(this), null;
              if (0 === (e2 = I(e2, t2)) && t2.ended) return 0 === t2.length && q(this), null;
              ...
              if (1 === t2.pipesCount) return e2 && e2 !== t2.pipes ? this : (e2 || (e2 = t2.pipes), t2.pipes = null, t2.pipesCount = 0, t2.flowing = false, e2 && e2.emit("unpipe", this, r3), this);
              if (!e2) {
              ...
              for (var o2 = 0; o2 < S.length; o2++) e2.on(S[o2], this.emit.bind(this, S[o2]));
        ...
        function h(e2, t2, r2) {
          ...
          if (e2._transformState.transforming) throw new s();
          return e2.push(null);
        }
        ...
        (function(r2, n) {
          (function() {
            ...
            function C(t2) {
              ...
              if (!r3 && !c.call(C, this)) return new C(t2);
            ...
            function A(e2, t2) {
              ...
              if (e2._writev && r3 && r3.next) {
                ...
                s2.entry = r3;
                for (var a2 = 0, l2 = true; r3; ) o2[a2] = r3, r3.isBuf || (l2 = false), r3 = r3.next, a2 += 1;
                ...
                for (; r3; ) {
                  ...
                  if (T(e2, t2, false, t2.objectMode ? 1 : u2.length, u2, c2, h2), r3 = r3.next, t2.bufferedRequestCount--, t2.writing) break;
                }
            ...
            e("inherits")(C, a), E.prototype.getBuffer = function() {
              ...
              return a2 && !l.isBuffer(e2) && (e2 = function(e3) {
                ...
                } else T(e3, t3, false, a3, n3, i3, o3);
                return u2;
        ...
        (function(r2) {
          (function() {
            ...
            var g = Object.getPrototypeOf(function() {
              ...
              if (this[u]) return Promise.resolve(p(void 0, true));
              ...
              if (i2) n2 = new Promise(/* @__PURE__ */ function(e3, t3) {
                ...
                var o2 = this[f].read();
                if (null !== o2) return Promise.resolve(p(o2, false));
        ...
        t.exports = function() {
          ...
          return t2 = e2, (r2 = [{ key: "push", value: function(e3) {
            ...
            for (var t3, r3, n2, i2 = s.allocUnsafe(e3 >>> 0), o2 = this.head, a2 = 0; o2; ) t3 = o2.data, r3 = i2, n2 = a2, s.prototype.copy.call(t3, r3, n2), a2 += o2.data.length, o2 = o2.next;
            return i2;
        ...
        t.exports = function() {
          ...
          if (Array.isArray(r2[0]) && (r2 = r2[0]), r2.length < 2) throw new o("streams");
        ...
        t.exports = { getHighWaterMark: function(e2, t2, r2, i) {
          ...
          if (null != o) {
            if (!isFinite(o) || Math.floor(o) !== o || o < 0) throw new n(i ? r2 : "highWaterMark", o);
            return Math.floor(o);
          }
        ...
        t.exports = function() {
          ...
          if (arguments.length > 0) {
            ...
            for (var t2 = 0; t2 < e2.length; t2++) e2[t2] = arguments[t2 + 2];
          }
            ...
            t.exports = function(e3) {
              return (e3 = e3 || {}).circles ? function(e4) {
                ...
                return e4.proto ? function e5(o) {
                  ...
                  if (Array.isArray(o)) return i(o, e5);
                  if (o instanceof Map) return new Map(i(Array.from(o), e5));
                  if (o instanceof Set) return new Set(i(Array.from(o), e5));
                  var s = {};
                  for (var a in t3.push(o), n.push(s), o) {
                    var l = o[a];
                    if ("object" != typeof l || null === l) s[a] = l;
                    else if (l instanceof Date) s[a] = new Date(l);
                    else if (l instanceof Map) s[a] = new Map(i(Array.from(l), e5));
                    else if (l instanceof Set) s[a] = new Set(i(Array.from(l), e5));
                    else if (ArrayBuffer.isView(l)) s[a] = r2(l);
                    else {
                      var u = t3.indexOf(l);
                      s[a] = -1 !== u ? n[u] : e5(l);
                    }
                  ...
                  if (o instanceof Set) return new Set(i(Array.from(o), e5));
                  var s = {};
                  for (var a in t3.push(o), n.push(s), o) if (false !== Object.hasOwnProperty.call(o, a)) {
                    var l = o[a];
                    if ("object" != typeof l || null === l) s[a] = l;
                    else if (l instanceof Date) s[a] = new Date(l);
                    else if (l instanceof Map) s[a] = new Map(i(Array.from(l), e5));
                ...
                function i(e5, i2) {
                  for (var o = Object.keys(e5), s = new Array(o.length), a = 0; a < o.length; a++) {
                    var l = o[a], u = e5[l];
                    if ("object" != typeof u || null === u) s[l] = u;
                    else if (u instanceof Date) s[l] = new Date(u);
                    else if (ArrayBuffer.isView(u)) s[l] = r2(u);
                    else {
                      var c = t3.indexOf(u);
                      s[l] = -1 !== c ? n[c] : i2(u);
                    }
                ...
                if (Array.isArray(n)) return t2(n, e4);
                if (n instanceof Map) return new Map(t2(Array.from(n), e4));
                if (n instanceof Set) return new Set(t2(Array.from(n), e4));
                var i = {};
                for (var o in n) {
                  var s = n[o];
                ...
                if (n instanceof Set) return new Set(t2(Array.from(n), e4));
                var i = {};
                for (var o in n) if (false !== Object.hasOwnProperty.call(n, o)) {
                  var s = n[o];
                  "object" != typeof s || null === s ? i[o] = s : s instanceof Date ? i[o] = new Date(s) : s instanceof Map ? i[o] = new Map(t2(Array.from(s), e4)) : s instanceof Set ? i[o] = new Set(t2(Array.from(s), e4)) : ArrayBuffer.isView(s) ? i[o] = r2(s) : i[o] = e4(s);
                }
                return i;
        ...
        r.StringDecoder = o, o.prototype.write = function(e2) {
          ...
          var r2 = function(e3, t3, r3) {
            ...
            if ((i2 = s(t3[n3])) >= 0) return i2 > 0 && (e3.lastNeed = i2 - 2), i2;
            if (--n3 < r3 || -2 === i2) return 0;
            if ((i2 = s(t3[n3])) >= 0) return i2 > 0 && (2 === i2 ? i2 = 0 : e3.lastNeed = i2 - 3), i2;
            return 0;
          }(this, e2, t2);
        ...
        o.prototype.parse = function(e2, t2, r2) {
          ...
          if (v2 = v2.trim(), !r2 && 1 === e2.split("#").length) {
            var w = l.exec(v2);
            if (w) return this.path = v2, this.href = v2, this.pathname = w[1], w[2] ? (this.search = w[2], this.query = t2 ? m.parse(this.search.substr(1)) : this.search.substr(1)) : t2 && (this.search = "", this.query = {}), this;
          }
          var _ = s.exec(v2);
          if (_) {
          ...
          if (E && (r2.hostname = "", r2.port = null, r2.host && ("" === S[0] ? S[0] = r2.host : S.unshift(r2.host)), r2.host = "", e2.protocol && (e2.hostname = null, e2.port = null, e2.host && ("" === d2[0] ? d2[0] = e2.host : d2.unshift(e2.host)), e2.host = null), _ = _ && ("" === d2[0] || "" === S[0])), w) r2.host = e2.host || "" === e2.host ? e2.host : r2.host, r2.hostname = e2.hostname || "" === e2.hostname ? e2.hostname : r2.hostname, r2.search = e2.search, r2.query = e2.query, S = d2;
          else if (d2.length) S || (S = []), S.pop(), S = S.concat(d2), r2.search = e2.search, r2.query = e2.query;
          else if (!i.isNullOrUndefined(e2.search)) {
            if (E) r2.hostname = r2.host = S.shift(), (I = !!(r2.host && r2.host.indexOf("@") > 0) && r2.host.split("@")) && (r2.auth = I.shift(), r2.host = r2.hostname = I.shift());
          ...
          if (!S.length) return r2.pathname = null, r2.search ? r2.path = "/" + r2.search : r2.path = null, r2.href = r2.format(), r2;
          for (var C = S.slice(-1)[0], T = (r2.host || e2.host || S.length > 1) && ("." === C || ".." === C) || "" === C, x = 0, A = S.length; A >= 0; A--) "." === (C = S[A]) ? S.splice(A, 1) : ".." === C ? (S.splice(A, 1), x++) : x && (S.splice(A, 1), x--);
        ...
        (function(e2) {
          (function() {
            ...
            t.exports = function(e3, t2) {
              ...
              return function() {
                if (!n) {
                  if (r2("throwDeprecation")) throw new Error(t2);
        ...
        t.exports = function e2(t2, r2) {
          ...
          return n;
          function n() {
            for (var e3 = new Array(arguments.length), r3 = 0; r3 < e3.length; r3++) e3[r3] = arguments[r3];
        ...
        t.exports = function() {
          for (var e2 = {}, t2 = 0; t2 < arguments.length; t2++) {
            var r2 = arguments[t2];
            for (var i in r2) n.call(r2, i) && (e2[i] = r2[i]);
          }
          return e2;
        };
        ...
        function n(e2) {
          var t2 = this;
          if (t2 instanceof n || (t2 = new n()), t2.tail = null, t2.head = null, t2.length = 0, e2 && "function" == typeof e2.forEach) e2.forEach(function(e3) {
            t2.push(e3);
          });
          else if (arguments.length > 0) for (var r2 = 0, i2 = arguments.length; r2 < i2; r2++) t2.push(arguments[r2]);
          return t2;
        }
        function i(e2, t2, r2) {
        ...
        function a(e2, t2, r2, n2) {
          if (!(this instanceof a)) return new a(e2, t2, r2, n2);
        ...
        t.exports = n, n.Node = a, n.create = n, n.prototype.removeNode = function(e2) {
          if (e2.list !== this) throw new Error("removing node which does not belong to this list");
          ...
          for (var e2 = 0, t2 = arguments.length; e2 < t2; e2++) o(this, arguments[e2]);
          return this.length;
        }, n.prototype.unshift = function() {
          for (var e2 = 0, t2 = arguments.length; e2 < t2; e2++) s(this, arguments[e2]);
          return this.length;
          ...
          t2 = t2 || this;
          for (var r2 = this.head, n2 = 0; null !== r2; n2++) e2.call(t2, r2.value, n2, this), r2 = r2.next;
        }, n.prototype.forEachReverse = function(e2, t2) {
          t2 = t2 || this;
          for (var r2 = this.tail, n2 = this.length - 1; null !== r2; n2--) e2.call(t2, r2.value, n2, this), r2 = r2.prev;
        }, n.prototype.get = function(e2) {
          for (var t2 = 0, r2 = this.head; null !== r2 && t2 < e2; t2++) r2 = r2.next;
          if (t2 === e2 && null !== r2) return r2.value;
        }, n.prototype.getReverse = function(e2) {
          for (var t2 = 0, r2 = this.tail; null !== r2 && t2 < e2; t2++) r2 = r2.prev;
          if (t2 === e2 && null !== r2) return r2.value;
        }, n.prototype.map = function(e2, t2) {
          t2 = t2 || this;
          for (var r2 = new n(), i2 = this.head; null !== i2; ) r2.push(e2.call(t2, i2.value, this)), i2 = i2.next;
          return r2;
        }, n.prototype.mapReverse = function(e2, t2) {
          t2 = t2 || this;
          for (var r2 = new n(), i2 = this.tail; null !== i2; ) r2.push(e2.call(t2, i2.value, this)), i2 = i2.prev;
          return r2;
        }, n.prototype.reduce = function(e2, t2) {
          var r2, n2 = this.head;
          if (arguments.length > 1) r2 = t2;
          else {
            if (!this.head) throw new TypeError("Reduce of empty list with no initial value");
            n2 = this.head.next, r2 = this.head.value;
          }
          for (var i2 = 0; null !== n2; i2++) r2 = e2(r2, n2.value, i2), n2 = n2.next;
          return r2;
          ...
          for (var i2 = this.length - 1; null !== n2; i2--) r2 = e2(r2, n2.value, i2), n2 = n2.prev;
          return r2;
        }, n.prototype.toArray = function() {
          for (var e2 = new Array(this.length), t2 = 0, r2 = this.head; null !== r2; t2++) e2[t2] = r2.value, r2 = r2.next;
          return e2;
        }, n.prototype.toArrayReverse = function() {
          for (var e2 = new Array(this.length), t2 = 0, r2 = this.tail; null !== r2; t2++) e2[t2] = r2.value, r2 = r2.prev;
          return e2;
        }, n.prototype.slice = function(e2, t2) {
          (t2 = t2 || this.length) < 0 && (t2 += this.length), (e2 = e2 || 0) < 0 && (e2 += this.length);
          var r2 = new n();
          if (t2 < e2 || t2 < 0) return r2;
          e2 < 0 && (e2 = 0), t2 > this.length && (t2 = this.length);
          for (var i2 = 0, o2 = this.head; null !== o2 && i2 < e2; i2++) o2 = o2.next;
          for (; null !== o2 && i2 < t2; i2++, o2 = o2.next) r2.push(o2.value);
          return r2;
          ...
          if (t2 < e2 || t2 < 0) return r2;
          e2 < 0 && (e2 = 0), t2 > this.length && (t2 = this.length);
          for (var i2 = this.length, o2 = this.tail; null !== o2 && i2 > t2; i2--) o2 = o2.prev;
          for (; null !== o2 && i2 > e2; i2--, o2 = o2.prev) r2.push(o2.value);
          return r2;
        }, n.prototype.splice = function(e2, t2, ...r2) {
          e2 > this.length && (e2 = this.length - 1), e2 < 0 && (e2 = this.length + e2);
          for (var n2 = 0, o2 = this.head; null !== o2 && n2 < e2; n2++) o2 = o2.next;
          var s2 = [];
          for (n2 = 0; o2 && n2 < t2; n2++) s2.push(o2.value), o2 = this.removeNode(o2);
          null === o2 && (o2 = this.tail), o2 !== this.head && o2 !== this.tail && (o2 = o2.prev);
          for (n2 = 0; n2 < r2.length; n2++) o2 = i(this, o2, r2[n2]);
          return s2;
